...
const int CANVASNAMEBUFFER = 15;
const int CLIPSNAMEBUFFER = 20;
const int MAXMENUSIZE = 81;

//holds the position to display clip number during play function
const int CLIPNUMPOS = 31;
...
/*
* Adds a new undo state to the front of undoList, containing
* a copy of the current canvas
* undoList is the list to which the new undo state is to be added
